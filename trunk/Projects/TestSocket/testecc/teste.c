...
int main(int argc, char *argv[])
{
	...
	struct sockaddr_in mAddr;   // estruturas de endereco em modo servidor e cliente
	int mSocket;            // sSocket - modo servidor - ouve
	...
	struct srunEnvelope msgRecv;           // envelope para comunicacao
