...
public:
	...
	* Simple constructor
	*/
	OOPCommunicationManager()          { f_num_proc = f_myself = 0; }
	/**
	* Destructor
	*/
	...
	*/
	virtual int IAmTheMaster()  { return 0; }
	/**
